...
if isInMATLAB
    ...
    [iFinite,iInfinite,iInflect] = getAllPeaks(y,minT);
...
%--------------------------------------------------------------------------
function [iPk,iInf,iInflect] = getAllPeaks(y,minT)
...
[iPk,iInflect] = findLocalMaxima(yTemp,minT);


%--------------------------------------------------------------------------
function [iPk, iInflect] = findLocalMaxima(yTemp,minT)
...
yFinite = ~isnan(yTemp);
iNeq = [1; 1 + find((abs(yTemp(1:end-1)-yTemp(2:end)) > minT) & ...
